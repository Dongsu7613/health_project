...
public class TogetherServiceImpl implements TogetherService {
	...
	public void commentDelete(String commentNo) {
		...
		togetherMapper.commentDelete(commentNo);
	...
	// 같이 운동해요 댓글 달기
	@Override
	public void insertCommentWrite(CommentDTO commentDto) {

		togetherMapper.insertCommentWrite(commentDto);
	...
	public void BoardDelete(String bid) {
		...
		togetherMapper.deleteBoardDelete(bid);
	}

	// 같이 운동해요 게시물 수정 Update하기
	@Override
	public void BoardModify(TogetherDTO togetherDto, MultipartFile file) {
		...
		togetherMapper.updateBoardModify(togetherDto);
	...
	// 같이 운동해요 작성후 DB 업로드
	@Override
	public void BoardWrite(TogetherDTO togetherDto, MultipartFile file) {
		...
		togetherMapper.insertBoardwrite(togetherDto);

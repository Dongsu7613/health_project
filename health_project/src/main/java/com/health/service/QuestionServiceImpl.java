...
public class QuestionServiceImpl implements QuestionService {
	...
	public void BoardDelete(String bid) {
		...
		questionMapper.deleteBoardDelete(bid);

	}
	// Question 게시물 수정
	@Override
	public void BoardModify(QuestionDTO questionDto, MultipartFile file) {
		// 원본파일 이름
		String orgfileName = file.getOriginalFilename();

		if (file.getSize() != 0) { // 파일 사이즈가 0이 아니면ㄴ
			// 파일 저장위치
			String fileUrl = "C:/workspace/health_projectlast/src/main/resources/static/upload/";
			// 이름에 시간 추가
		...
		questionMapper.updateBoardModify(questionDto);
	...
	// Question 게시물 작성
	@Override
	public void BoardWrite(QuestionDTO questionDto, MultipartFile file) {
		...
		questionMapper.insertBoardwrite(questionDto);
